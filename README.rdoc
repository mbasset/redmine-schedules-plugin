...
This plugin requires Redmine 0.9.0 or above and the Holidays gem (available from
http://code.dunae.ca/holidays/ or through "gem install holidays").

Originally developed by Gossamer Threads Inc. (http://www.gossamer-threads.com)
Original developer: Brad Beattie

== Installation

If you are directly setting up the plugin via git, remember to rename the folder
of the plugin to redmine_schedules. By default git clone will create it as 
redmine-schedules-plugin. 

== Requirements

This plugin was tested on Redmine 0.9.2 on linux (Fedora 12) under webbrick and thin.
...
==== REMEMBER to change plugin folder name to /plugins/redmine_schedules
...
If your patch has gone in and you don't find your name in here do let me know and sorry for the omission.

== Other information
This version of a plugin uses Holidays gem, and it requires Redmine 0.9.0 or above.
